...
public class DBService {
	...
	public void instanciaDB() { 
		perfil.add(0);
		Usuario usuario = new Usuario(null, "Administrador", "bebidas@email.com", encoder.encode("bebidasbebidas"));
		usuario.addPerfil(Perfil.ADMIN);
		usuarioRepository.save(usuario);
		
		Cliente cli1 = new Cliente(null, "Marcelo Machado", "987654321", "65992822316", "Rua Fernando de Noronha", "marcelo@mail.com");
		...
		Fornecedor f1 = new Fornecedor(null, "Ambev", "768675/0001", "Rua das Acácias", "65936136743", "ambev@mail.com", null);
		Fornecedor f2 = new Fornecedor(null, "Coca Cola", "7565643/0001", "Av. Mario Andreaza", "65936826545", "coke@mail.com", null);
		Fornecedor f3 = new Fornecedor(null, "ElmaChips", "9898765/0001", "Rua Trinta e dois", "65967857898", "elmachips@mail.com", null);
